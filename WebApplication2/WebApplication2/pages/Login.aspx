<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebApplication2.pages.Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <div>
    <a href="~/pages/Register.aspx" runat="server">Create New User</a>
        </div>
